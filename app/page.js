          ...
          <div className='flex items-center justify-between w-full lg:flex-col'>
            ...
            <div className='w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center'>
              ...
              <p className='my-4 text-base font-medium md:text-sm sm:text-xs'>
                As a seasoned Front End Developer, I work on turning ideas into scalable products and innovative websites and web applications. Dive into my portfolio to learn more about me and what I do. Also, please visit my Github to see more projects and links to them
              </p>
